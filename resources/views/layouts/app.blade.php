...
<body>
    <header>
        ...
        <div class="menu-nav-icon" data-nav-menu="#main-menu">
            <i class="ion-navicon" style="zoom: 2"></i>
        </div>
                    ...
                    <ul class="drop-down-menu">
                        <li>
                            <a href="{{ route('public.noticias', 'nacional') }}"
                                ...
                                <img src="https://flagsapi.com/BO/flat/24.png" style="width: 20px;"> &nbsp; NACIONAL
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('public.noticias', 'regional') }}"
                                onclick="toHref('{{ route('public.noticias', 'regional') }}')">
                                <img src="https://flagsapi.com/MC/flat/24.png" style="width: 20px;"> &nbsp; REGIONAL
                            </a>
                        </li>
                        <li>
            ...
            @else
                ...
                <li class="{{ Request::path() == 'categorias' ? 'active' : '' }}">
                    <a href="{{ route('categorias.index') }}"
                        onclick="toHref('{{ route('categorias.index') }}')">CATEGORÍAS</a>
                </li>
                <li class="text-center">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button class="btn btn-logout btn-block">CERRAR SESIÓN <i
