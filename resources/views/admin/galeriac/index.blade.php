    ...
    <section class="section blog-area" style="margin-top: 200px;">
        ...
        <div class="container">
            <div class="col-md-12 col-sm-12 text-center">
                <a href=" {{ route('articuloscom.index', $post->id_comunidad) }} " class="btn btn-link">
            ...
            <div class="row">
                ...
                @endif
                <form class="col-md-6 col-sm-12 col-xs-12" action=" {{ route('galeriacom.store') }} " method="POST"
                        ...
                        @if (count($lista) > 0)
                            @foreach ($lista as $item)
                                <div class="col-lg-4 col-md-6 col-sm-12 text-center m-2  p-0">
                                    <a href="{{ asset('blog/public/uploads/galeriac/' . $item->imagen) }}"
                                        data-fancybox="images" data-caption="Backpackers following a dirt trail">
                                        <img src=" {{ asset('blog/public/uploads/galeriac/' . $item->imagen) }} "
                                            class="img-thumbnail" />
                                    </a>
                                    <br>
                                    <form action=" {{ route('galeriacom.destroy') }} " method="POST"
