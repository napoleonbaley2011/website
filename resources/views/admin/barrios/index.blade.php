...
@section('listas')
    <h3 class="text-center m-2">.:: Barrrios ::.</h3>
    <table class="table table-bordered" id="example">
        <thead>
            <tr>
                <th class="no-sort d-none d-md-block">#</th>
                <th class="no-sort">Barrio</th>
                <th class="no-sort d-none d-md-block">Distrito</th>
        ...
        <tbody>
            @foreach ($lista as $item)
                <tr>
                    ...
                    {{-- <td>
                        <a href=" {{ route('articulos.index', $item->id) }} " class="btn btn-outline-success btn-sm">Ver
                            publicaciones</a>
                    </td> --}}
                </tr>
            @endforeach
