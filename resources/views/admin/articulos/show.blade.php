            ...
            <div class="col-md-8 offset-md-2">
                ...
                <div class="single-post mt-4">
                    <div class="image-wrapper">
                        <div class="image-wrapper">
                            <img src="{!! asset('blog/public/uploads/articulo/'.$articulo->imagen) !!}" alt="Blog Image">
                        </div>
                    </div>
                    ...
                    <p>{!! $articulo->cuerpo !!}</p>
                    <a class="btn btn-secondary mt-4 float-right" href=" {{ route('articulos.index',['id' => $articulo->id_barrio]) }} ">
                        <b>Volver</b>
                    </a>
                </div>
            </div>
